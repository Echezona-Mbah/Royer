      ...
      <div class="main-panel">
        ...
        <div class="content-wrapper">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h2 style="text-align: center;color:#c80d9f">The 10 Men Investment Contact</h2>
                    ...
                    <form method="POST" action="{{ route('contact-us') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="address" name="address" placeholder="Address" >
                        </div>

                        <div class="form-group">
                            <label for="exampleInputPhone1">Phone</label>
                            <input type="number" class="form-control" name="phone" name="phone" placeholder="phone" >
                        </div>
