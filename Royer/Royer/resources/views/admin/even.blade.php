      ...
      <div class="main-panel">
        ...
        <div class="content-wrapper">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h2 style="text-align: center;color:#c80d9f">Evens Of 10 Men Investment</h2>
                    <p class="card-description">
                    </p><br>
                    <form method="POST" action="{{ route('even-us') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="amount" class="form-control" name="amount" value="" id="exampleInputUsername1" placeholder="Amount">
                        </div>
