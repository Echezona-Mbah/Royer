            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('new.update', $allnew->id) }}" enctype="multipart/form-data">
                        @csrf 
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="title" value="{{$allnew->title}}" id="exampleInputUsername1" placeholder="title">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputUsername1">Date</label>
                            <input type="date" class="form-control" name="dob" value="{{$allnew->dob}}" id="exampleInputUsername1" placeholder="Date">
                        </div>

                                          
                        <div class="form-group">
                            <label for="exampleInputPhone1">Discription</label>
                            <input type="text" class="form-control" name="discription" value="{{$allnew->discription}}" id="exampleInputPhone1" placeholder="discription">
                        </div>
