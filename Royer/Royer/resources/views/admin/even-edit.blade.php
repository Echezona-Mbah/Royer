            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('even.update', $alleven->id) }}" enctype="multipart/form-data">
                        @csrf 
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="title" value="{{$alleven->title}}" id="exampleInputUsername1" placeholder="title">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputUsername1">Date</label>
                            <input type="date" class="form-control" name="dob" value="{{$alleven->dob}}" id="exampleInputUsername1" placeholder="Date">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="discription" value="{{$alleven->discription}}" id="exampleInputPhone1" placeholder="discription">
                        </div>
